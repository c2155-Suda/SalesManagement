...
namespace SalesManagement_SysDev
{
    class ArrivalDbConnection
    {
            ...
            try
            {
                using (var context = new SalesManagement_DevContext())
                {
                    var tb = from Arrival in context.T_Arrivals
                             ...
                             group new { Arrival, subEmployee, Client, SalesOfficce } by new { Arrival.ArID } into g
            ...
            try
            {
                using (var context = new SalesManagement_DevContext())
                {
                    var tb = from Arrival in context.T_Arrivals
                             ...
                             where Arrival.ArFlag == selectCondition.ArFlag &&
                             (selectCondition.ArID == 0 || Arrival.ArID == selectCondition.ArID) &&
                             (selectCondition.EmID == 0 || selectCondition.EmID == Arrival.EmID) &&
                             (selectCondition.ClID == 0 || selectCondition.ClID == Arrival.ClID) &&
                             (selectCondition.SoID == 0 || selectCondition.SoID == Arrival.SoID) &&
                             (selectCondition.OrID == 0 || selectCondition.OrID == Arrival.OrID) &&
                             ...
                             (selectCondition.PrID == 0 || selectCondition.PrID == subArrivalDet.PrID) &&
            ...
            try
            {
                using (var context = new SalesManagement_DevContext())
                {
                    var tb = from ArrivalDet in context.T_ArrivalDetails
                             ...
                             (selectCondition.ArID == 0 || ArrivalDet.ArDetailID == selectCondition.ArDetailID) &&
                             (selectCondition.PrID == 0 || ArrivalDet.PrID == selectCondition.PrID) &&
        ...
        public void FinalizeArrivalData(T_Shipment regData, List<T_ShipmentDetail> regDetailData)
        {
            try
            {
                using (var context = new SalesManagement_DevContext())
        ...
        public bool CheckSyukkoIsActive(int Arid)
        {
            try
            {
                using (var context = new SalesManagement_DevContext())
